...
var (
	...
	adminPermissionRules = []adminPermissionRule{
		...
		{Method: "POST", Pattern: "/api/admin/topic/batch/preview", Permissions: []PermissionDefinition{PermissionTopicBatchRecommend, PermissionTopicBatchDelete}},
		{Method: "POST", Pattern: "/api/admin/topic/batch", Permissions: []PermissionDefinition{PermissionTopicBatchRecommend, PermissionTopicBatchDelete}},
		...
		{Method: "POST", Pattern: "/api/admin/user/batch/preview", Permissions: []PermissionDefinition{PermissionUserBatchForbidden, PermissionUserBatchForbiddenForever}},
		{Method: "POST", Pattern: "/api/admin/user/batch", Permissions: []PermissionDefinition{PermissionUserBatchForbidden, PermissionUserBatchForbiddenForever}},
		...
		{Method: "POST", Pattern: "/api/admin/user-report/batch/preview", Permissions: []PermissionDefinition{PermissionUserReportBatchProcess}},
		{Method: "POST", Pattern: "/api/admin/user-report/batch", Permissions: []PermissionDefinition{PermissionUserReportBatchProcess}},
