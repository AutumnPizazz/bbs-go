const enUS = {
  ...
  dashboard: {
    ...
    actions: {
      ...
      save: "Save",
      saveView: "Save view",
      saveViewPrompt: "Enter a view name",
    ...
    messages: {
      ...
      answerUnaccepted: "Answer acceptance removed",
      attachmentCleanupStarted: "Orphan attachment cleanup started",
      messageTaskCreated: "Broadcast draft created",
      messageTaskStarted: "Broadcast task started",
      messageTaskRetried: "Failed deliveries restarted",
    },
    confirm: {
    ...
    forbidden: {
      ...
      confirm7Days: "Ban this user for 7 days?",
      confirmForever: "Permanently ban this user?",
    ...
    reportProcess: {
      ...
      scopeCurrent: "Only this report",
      scopeObject: "Target and {count} other pending reports",
    },
    messageTask: {
      title: "Broadcast Message",
      description: "Preview the recipient count, save a draft, then start delivery from the task record.",
      targetAll: "All active users",
      targetRole: "Users in role",
      targetCategory: "Active users in category",
      targetId: "Role or category ID",
      preview: "Preview recipients",
      saveDraft: "Save draft",
      recipientCount: "{count} recipients",
      records: "Delivery records",
      empty: "No broadcast tasks",
      send: "Send",
      retry: "Retry failures",
    },
    answerDialog: {
      title: "Answers",
      empty: "No answers found for this topic.",
    },
    gender: {
      male: "Male",
      female: "Female",
    ...
    settingsForm: {
      ...
      announcement: {
        ...
        confirmTitle: "Confirm announcement publish",
        confirmDescription: "The new notice will be visible immediately and a publish record will be created.",
    ...
    pages: {
      ...
      comments: {
        title: "Comments",
        description: "Review comments in accessible topics and remove harmful content.",
      },
      userReports: {
        title: "User Reports",
      ...
      operateLogs: {
        ...
        description: "Trace administrative actions and their request sources.",
      },
      tags: {
        title: "Tags",
        description: "Create, edit, and enable or disable topic tags.",
      },
      dictionaryTypes: {
        title: "Dictionary Types",
        description: "Manage reusable dictionary categories and codes.",
      },
      dictionaryItems: {
        title: "Dictionary Items",
        description: "Manage hierarchical dictionary values and ordering.",
      },
      favorites: {
        title: "Favorites",
        description: "Inspect saved content without changing user actions.",
      },
      votes: {
        title: "Votes",
        description: "Manage vote definitions and inspect participation counts.",
      },
      voteOptions: {
        title: "Vote Options",
        description: "Review and correct options belonging to a vote.",
      },
      voteRecords: {
        title: "Vote Records",
        description: "Inspect vote records without editing user behavior.",
      },
      attachments: {
        title: "Attachment Management",
        description: "Query attachments by file, type, user, or topic while preserving references before removal.",
        cleanupTitle: "Orphan attachment cleanup",
        cleanupDescription: "Asynchronously remove objects older than 7 days that are not bound to a topic.",
      },
      messages: {
        title: "Site Messages",
        description: "Send traceable site messages to individual users and review delivery records.",
      },
      health: {
        title: "Health & Background Tasks",
        description: "Inspect database, storage, and background task status, and start controlled tasks when permitted.",
        components: "Service components",
        tasks: "Background tasks",
        taskFailed: "Failed tasks detected",
        taskRunning: "Task running",
        taskIdle: "No active tasks",
        taskReady: "No errors",
        start: "Start",
        componentNames: {
          database: "Database",
        ...
        taskNames: {
          searchReindex: "Search index rebuild",
        ...
        backup: {
          ...
          noErrors: "No errors",
          enabled: "Enable scheduled backups (takes effect after restart)",
          progressTitle: "Backup progress",
          restoreProgressTitle: "Restore progress",
          progressPhase: "Current phase",
          phaseWorking: "Working",
          phasePreparing: "Preparing",
          phaseDumping: "Exporting database",
          phaseVerifying: "Verifying backup file",
          phaseSafetyBackup: "Creating a safety backup of the current database",
          phaseRestoring: "Importing database",
          schedule: "Cron schedule",
          scheduleHelpLabel: "Explain Cron schedule",
          ...
          create: "Back up now",
          created: "Backup task started",
          saved: "Backup configuration saved",
          deleted: "Backup deleted",
          restore: "Restore",
          restoreStarted: "Restore task started",
          restoreRunning: "Database restore is running",
          createTitle: "Create database backup",
          createDescription: "A backup can use significant disk and database resources. Create it now?",
          saveTitle: "Save backup configuration",
          saveDescription: "The schedule and retention policy will be written to the server configuration. Save them?",
          download: "Download",
          downloadTitle: "Download database backup",
          downloadDescription: "This file may contain the complete site data. Confirm that it will be stored securely.",
          delete: "Delete",
          deleteTitle: "Delete database backup",
          deleteDescription: "The backup file cannot be recovered from the dashboard after deletion. Continue?",
    ...
    overview: {
      ...
      metrics: {
        ...
        forbiddenUsers: "Currently muted users",
        failedTasks: "Failed background tasks",
        failedMessageTasks: "Failed broadcast tasks",
      },
      pending: {
        title: "Pending work",
        description:
      ...
      trend: {
        title: "7-day trend",
        description: "Daily users, content, comments, and report volume.",
        users: "Users",
        topics: "Topics",
        comments: "Comments",
        reports: "Reports",
      ...
      breakdown: {
        categories: "Content by category (topics / comments)",
        roles: "Users by role",
      },
    },
  },
